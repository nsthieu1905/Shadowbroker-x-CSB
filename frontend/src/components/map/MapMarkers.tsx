    ...
    <>
      {clusters.map((c: any) => (
        <Marker key={`${prefix}-${c.id}`} longitude={c.lng} latitude={c.lat} anchor="center" style={{ zIndex: 1 }}>
          <div style={{ ...LABEL_BASE, color: "#fff", fontSize: "11px", textAlign: "center" }}>{c.count}</div>
        </Marker>
      ))}
    </>
  );
        ...
        return (
          ...
          >
            <div style={{ ...LABEL_BASE, textShadow: LABEL_SHADOW_EXTRA, whiteSpace: "nowrap", textAlign: "center" }}>
              <div style={{ color: "#ffaa00", fontSize: "11px", fontWeight: "bold" }}>[[{s.name}]]</div>
              {s.estimated && (
                <div style={{ color: "#ff6644", fontSize: "8px", letterSpacing: "1.5px" }}>EST. POSITION — OSINT</div>
              )}
            </div>
          </Marker>
        );
          ...
          >
            <div className="relative group/alert">
              ...
              >
                ...
                <div
                  className="absolute inset-0 border border-current rounded opacity-50 animate-pulse"
                ...
                <div style={{ fontSize: "10px", letterSpacing: "0.5px" }}>Tin tức mới</div>
                <div
                  style={{
                    color: "#fff",
                    fontSize: "9px",
