          ...
          >
            ...
            <div className="p-4 border-b border-[var(--border-primary)]/40 bg-[var(--bg-primary)]/60">
              <div className="flex items-center justify-between mb-3">
                <div className="flex flex-col">
                  <span className="text-xs text-cyan-300 font-mono tracking-wide">
                    {activeFeed ? activeFeed.name : "KHÔNG CÓ TÍN HIỆU"}
                  </span>
                  <span className="text-[9px] text-[var(--text-muted)] font-mono">
                    {activeFeed ? `VỊ TRÍ: ${activeFeed.location.toUpperCase()}` : "ĐANG CHỜ ĐIỀU CHỈNH..."}
                  </span>
                </div>
                {activeFeed && (
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <FastForward size={12} />
                  {isScanning ? "ĐANG QUÉT..." : "TỰ ĐỘNG QUÉT"}
                </button>
                ...
                <button
                  ...
                  title="Bấm lên bản đồ để bắt tín hiệu khu vực"
                >
                  EAVESDROP
                </button>
            ...
            <div className="flex-col overflow-y-auto styled-scrollbar max-h-64 p-2">
              {feeds.length === 0 ? (
                <div className="text-[10px] text-cyan-700 font-mono text-center p-4">ĐANG TÌM TẦN SỐ...</div>
              ) : (
