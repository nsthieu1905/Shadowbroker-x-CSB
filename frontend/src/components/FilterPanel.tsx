...
export default function FilterPanel({ data, activeFilters, setActiveFilters }: FilterPanelProps) {
  ...
  const modalConfigs: Record<string, ModalConfig> = {
    commercial: {
      title: "CHUYẾN BAY THƯƠNG MẠI",
      icon: <Plane size={13} className="text-cyan-400" />,
      accentColor: "#00bcd4",
      accentColorName: "cyan",
      fields: [
        { key: "commercial_departure", label: "ĐIỂM ĐI", options: uniqueOrigins },
        { key: "commercial_arrival", label: "ĐIỂM ĐẾN", options: uniqueDestinations },
        { key: "commercial_airline", label: "HÃNG BAY", options: uniqueAirlines, optionLabels: airlineLabels },
      ],
    },
    private: {
      title: "TƯ NHÂN / PHẢN LỰC",
      icon: <Plane size={13} className="text-orange-400" />,
      accentColor: "#FF8C00",
      accentColorName: "orange",
      fields: [
        { key: "private_callsign", label: "CALLSIGN / SỐ ĐĂNG KÝ", options: uniquePrivateCallsigns },
        { key: "private_aircraft_type", label: "LOẠI MÁY BAY", options: uniquePrivateAircraftTypes },
      ],
    },
    military: {
      title: "QUÂN SỰ",
      ...
      fields: [
        { key: "military_country", label: "QUỐC GIA / SỐ ĐK", options: uniqueMilCountries },
        { key: "military_aircraft_type", label: "LOẠI MÁY BAY", options: uniqueMilAircraftTypes },
      ],
    },
    tracked: {
      title: "MÁY BAY THEO DÕI",
      icon: <Star size={13} className="text-pink-400" />,
      accentColor: "#EC4899",
      accentColorName: "pink",
      fields: [
        { key: "tracked_category", label: "NHÓM", options: uniqueTrackedCategories },
        { key: "tracked_owner", label: "ĐƠN VỊ / TỔ CHỨC", options: uniqueTrackedOperators },
      ],
    },
    ships: {
      title: "TÀU / HÀNG HẢI",
      ...
      fields: [
        { key: "ship_name", label: "TÊN TÀU", options: uniqueShipNames },
        { key: "ship_type", label: "LOẠI TÀU", options: uniqueVesselTypes },
      ],
    },
  };
  ...
  const sections = [
    ...
    { key: "military", title: "QUÂN SỰ", icon: <Shield size={11} className="text-yellow-400" />, color: "yellow" },
    { key: "tracked", title: "MÁY BAY THEO DÕI", icon: <Star size={11} className="text-pink-400" />, color: "pink" },
    { key: "ships", title: "TÀU / HÀNG HẢI", icon: <Ship size={11} className="text-blue-400" />, color: "blue" },
  ];
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-[var(--text-muted)] font-mono tracking-widest">BỘ LỌC DỮ LIỆU</span>
            {activeCount > 0 && (
